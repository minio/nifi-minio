...
import static io.minio.nifi.s3fs.AmazonS3Factory.*;
...
import io.minio.nifi.s3fs.util.ExposingAmazonS3Client;
import io.minio.nifi.s3fs.util.ExposingAmazonS3ClientFactory;
...
public class AmazonS3ClientFactoryTest {
    ...
    public void neverTrustTheDefaults() {
        ...
        props.setProperty(REQUEST_METRIC_COLLECTOR_CLASS, "io.minio.nifi.s3fs.util.NoOpRequestMetricCollector");
        ...
        assertEquals("class io.minio.nifi.s3fs.util.NoOpRequestMetricCollector", client.getRequestMetricsCollector().getClass().toString());
    ...
    public void wrongMetricsCollector() {
        ...
        props.setProperty(ACCESS_KEY, "I want access");
        props.setProperty(SECRET_KEY, "I'll never teeeeeellllll!");
        props.setProperty(REQUEST_METRIC_COLLECTOR_CLASS, "io.minio.nifi.s3fs.util.WrongRequestMetricCollector");
        clientFactory.getAmazonS3(S3EndpointConstant.S3_GLOBAL_URI_TEST, props);
    }
