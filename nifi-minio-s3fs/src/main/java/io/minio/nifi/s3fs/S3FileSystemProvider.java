...
import io.minio.nifi.s3fs.attribute.S3BasicFileAttributeView;
import io.minio.nifi.s3fs.attribute.S3BasicFileAttributes;
import io.minio.nifi.s3fs.attribute.S3PosixFileAttributeView;
import io.minio.nifi.s3fs.attribute.S3PosixFileAttributes;
import io.minio.nifi.s3fs.util.AttributesUtils;
...
public class S3FileSystemProvider extends FileSystemProvider {
    ...
    public void createDirectory(Path dir, FileAttribute<?>... attrs) throws IOException {
        ...
        if (!directoryKey.equals("/")) {
            ...
            s3Path.getFileSystem().getClient().putObject(bucketName, directoryKey,
